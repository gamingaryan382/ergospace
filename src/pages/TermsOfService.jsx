...
export default function TermsOfService() {
  return (
    <div style={{ paddingTop: '1.5rem', minHeight: '100vh', backgroundColor: 'var(--bg-primary)' }}>
      <div className="container-premium" style={{ paddingBottom: '6rem', maxWidth: '850px', margin: '0 auto' }}>
        ...
        <div style={{ color: 'var(--text-primary)', lineHeight: 1.8, fontSize: '0.95rem', fontWeight: 300, display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          <p>
            Welcome to ERGO SPACE website.
          </p>
          
          <p>
            The terms “We” / “Us” / “Our”/ ”Company” individually and collectively refer to ERGO SPACE (Tirupati Work Space Solutions Private Limited) and the terms “Visitor” / ”User” / “You” / “Your” / “Yourself” refer to the users.
          </p>
          
          <p>
            This page states the Terms and Conditions under which you (Visitor) may visit this website (<a href="http://www.ergospace.in" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>www.ergospace.in</a> | <a href="http://www.shop.ergospace.in" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>www.shop.ergospace.in</a> | <a href="http://www.workfromhomekits.in" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>www.workfromhomekits.in</a>). Please read this page carefully. If you do not accept the Terms and Conditions stated here, we would request you to exit this website. The business, any of its business divisions and / or its subsidiaries, associate companies or subsidiaries to subsidiaries or such other investment companies (in India or abroad) reserve their respective rights to revise these Terms and Conditions at any time by updating this posting. You should visit this page periodically to re-appraise yourself of the Terms and Conditions, because they are binding on all users of this Website.
          </p>
          ...
          <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '2rem', marginTop: '1rem' }}>
            ...
            <h4 style={{ fontSize: '1.1rem', fontWeight: 600, marginTop: '1.5rem', marginBottom: '0.5rem' }}>
              (A) Security Rules
            </h4>
            <p>
          ...
          <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '2rem', marginTop: '1rem' }}>
            ...
            <p>
              The User unilaterally agree to indemnify and hold harmless, without objection, the Company, its officers, directors, employees and agents from and against any claims, actions and/or demands and/or liabilities and/or losses and/or damages whatsoever arising from or resulting from their use of (<a href="http://www.ergospace.in" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>www.ergospace.in</a> | <a href="http://www.shop.ergospace.in" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>www.shop.ergospace.in</a> | <a href="http://www.workfromhomekits.in" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>www.workfromhomekits.in</a>) or their breach of the terms of service.
            </p>
          </div>
          ...
          <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '2rem', marginTop: '1rem' }}>
            ...
            <p>
              User further agrees that Company shall not be liable for any damages arising from interruption, suspension or termination of service, including but not limited to direct or indirect or/and incidental or/and special consequential or/and exemplary damages, whether such interruption or/and suspension or/and termination was justified or not, negligent or intentional, inadvertent or advertent.
            </p>
            <p>
              User further agrees that Company shall not be responsible or liable to user, or anyone, for the statements or conduct of any third party of the service. In sum, in no event shall Company’s total liability to the User for all damages or/and losses or/and causes of action exceed the amount paid by the User to Company, if any, that is related to the cause of action.
            </p>
          </div>
          ...
          <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '2rem', marginTop: '1rem' }}>
            ...
            <p>
              Privacy Policy is an electronic record in the form of an electronic contract formed under the Information Technology Act, 2000 and the rules made thereunder and the amended provisions pertaining to electronic documents / records in various statutes as amended by the Information Technology Act, 2000. This Privacy Policy does not require any physical, electronic or digital signature.
            </p>
            <p>
              This Privacy Policy is a legally binding document between you and us (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and us for your use of the website (<a href="http://www.ergospace.in" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>www.ergospace.in</a> | <a href="http://www.shop.ergospace.in" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>www.shop.ergospace.in</a> | <a href="http://www.workfromhomekits.in" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>www.workfromhomekits.in</a>).
            </p>
            <p>
            ...
            <p style={{ paddingLeft: '1rem', borderLeft: '2px solid var(--accent)' }}>
            ...
            <p>
              We shall not be responsible for any damages your business may suffer to the extent permissible by law. We make no warranties of any kind, express, implied, statutory or otherwise for any Service we provide.
            </p>
            <p>
              Under no circumstances, we, our officers, agents or anyone else involved in creating, producing or distributing the service shall be liable for any direct, indirect, incidental, special or consequential damages that result from the use or the inability to use the Service; or that results from mistakes, omissions, interruptions, deletion of files, errors, defects, delays in operation, or transmission or any failure of performance, whether or not limited to acts of God, communication failure, theft, destruction or unauthorized access to our records, programs or services. Force Majeure is applicable.
            </p>
            <p>
              We disclaim any intention to censor, edit or engage in ongoing review or surveillance of communications stored on or transmitted through its facilities by customers or others. We may however review, delete or block access to communications that could harm e-Commerce websites, its customers or third parties.
            </p>
            <p>
              The grounds on which we may take such action include, but are not limited to, actual or potential violations of our Terms of Service and/or Acceptable Use of Policy.
            </p>
            <p>
              We reserve the right to revise our policies or terms of service at any time. Notification of all amendments will be displayed publicly on our website – it is your responsibility to check our website periodically.
            </p>
            <p>
            ...
            <p style={{ marginTop: '1rem', paddingLeft: '1rem', borderLeft: '3px solid var(--accent)' }}>
              <strong>MR. VIVEK GUPTA (Grievance Officer)</strong><br />
              TIRUPATI WORK SPACE SOLUTIONS PRIVATE LIMITED<br />
              S-27/17, DLF PHASE 3, GURUGRAM, HARYANA 122002<br />
              E-mail ID: <a href="mailto:vivek@ergospace.in" style={{ color: 'var(--accent)' }}>vivek@ergospace.in</a><br />
